...
def play_video(item, strm=False):
    ...
    data = httptools.downloadpage(mediaurl,only_headers=True)
...
def set_player(item, xlistitem, mediaurl, view, strm):
    ...
    # Si es un fichero strm no hace falta el play
        ...
        elif (config.get_setting("player_mode") == "0" and not item.isPlayable == "true") or \
        ...
        elif config.get_setting("player_mode") == "1" or item.isPlayable == "true":
            logger.info("mediaurl :" + mediaurl)
